...
while True:
    ...
    if score>=10:
        ...
        if apple_collider.y > height or apple_collider2.y > height:
            apple_collider_last = apple_collider.x
            apple_collider.x = random.randrange(0, width)
            apple_collider.y = 0
            ...
            diff = 300
            #difference between apple spawns (min 300px difference between the last spawn)
            while apple_collider_last + diff >= apple_collider.x and apple_collider_last - diff <= apple_collider.x or apple_collider2_last + diff >= apple_collider2.x and apple_collider2_last - diff <= apple_collider2.x:
                apple_collider.x = random.randrange(0, width)
                apple_collider.y = 0
                apple_collider2.x = random.randrange(0, width)
                apple_collider2.y = 0
